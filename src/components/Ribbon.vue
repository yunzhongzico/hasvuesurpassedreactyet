<template>
  <a href="https://github.com/yunzhongzico/hasvuesurpassedreactyet" class="github" aria-label="View source on Github">
    <svg width="80" height="80" viewBox="0 0 250 250" style="fill:#fff; color:#42b983; position: absolute; top: 0; border: 0; right: 0;" aria-hidden="true">
...
<style> /* Credit http://tholman.com/github-corners/ */
  .github:hover .arm {
